...
class UserClass {
  ...
  static removeVideo(payload) {
    ...
    console.log("id", _mongoose.default.Types.ObjectId(payload.id));
    console.log("userId", _mongoose.default.Types.ObjectId(payload.userId));
...
var _default = _mongoose.default.model("User", _dbSchema.default);
